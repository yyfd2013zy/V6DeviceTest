...
public class CameraManager implements CameraPreview.CameraPreviewListener {
    private final String TAG = "FACE_KS_CameraManager";
...
//                        }
                        ...
                        previewSize = sz;
                        listener.onOpenResult(true);
                    }else {
                        listener.onOpenResult(false);
                    }
                    return null;
                }
